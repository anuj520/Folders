...
music.addEventListener("ended",()=>{
 ...
 btn.addEventListener("click",()=>{
   menu.style.width = "20%"
    ...
    menu.style.transition = "all 2.3s linear"
...
video.src = "24.mp4"
  let ki =   keyup.addEventListener("mouseover",()=>{
    ...
    menu_song.style.margin = "-71rem 0px 0px -100px";
...
keydown.addEventListener("mouseover",()=>{
 ...
 next.addEventListener("click",()=>{
   menu_song.style.background = `linear-gradient(rgba(22,22,22,0.1),rgba(22,22,22,99)),url(${index}.jpg)` 
...
//   console.log(mainMaster);
 ...
 mainMaster13.addEventListener("click",()=>{
    menu_song.video = `linear-gradient(rgba(22,22,22,0.8),rgba(22,22,22,99)),url(${1}.mp4)` 
    menu_song.style.backgroundSize = "cover"
    menu_song.style.backgroundRepeat = "no-repeat"
  })
...
//   console.log(mainMaster);
 mainMaster15.addEventListener("click",()=>{
    menu_song.style.background = `linear-gradient(rgba(22,22,22,0.8),rgba(22,22,22,99)),url(https://rare-gallery.com/mocahbig/1417186-alan-walker-music-hd-dj-4k-5k-8k.jpg)` 
    menu_song.style.backgroundSize = ""
    menu_song.style.backgroundRepeat = ""
  })
...
const mostData = (count)=>{
  setInterval(() => {
    let p = count--
    if (p == 0) {
      img1.style.minWidth = `${p}%`;
      img1.style.transition = "all 1.3s linear";
    }
if (p== -270) {
  img2.style.minWidth = `0%`;
img2.style.transition = "all 1.3s linear";
}
if (p== -470) {
  img3.style.minWidth = `0%`;
img3.style.transition = "all 1.3s linear";
}
if (p== -670) {
  img4.style.minWidth = `0%`;
img4.style.transition = "all 1.3s linear";
}if (p== -870) {
  img5.style.minWidth = `0%`;
  img5.style.transition = "all 1.3s linear";
}
if (p== -1070) {
  img6.style.minWidth = `0%`;
  img6.style.transition = "all 1.3s linear";
}
if (p== -1270) {
  img7.style.minWidth = `0%`;
  img7.style.transition = "all 1.3s linear";
}
Clickbtn.addEventListener('click',()=>{
  if (p> -1270) {
   img7.style.minWidth = `100%`;
   img7.style.transition = "all 1.3s linear";
  }
   if(p> -1070) {
    img6.style.minWidth = `100%`;
    img6.style.transition = "all 1.3s linear";
   }
   if(p> -870) {
    img5.style.minWidth = `100%`;
    img5.style.transition = "all 1.3s linear";
   }
   if(p> -670) {
    img4.style.minWidth = `100%`;
    img4.style.transition = "all 1.3s linear";
   }
   if(p> -470) {
